...
class InferencerMeta(ABCMeta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        all_kwargs = self.preprocess_kwargs | self.forward_kwargs | self.visualize_kwargs | self.postprocess_kwargs
...
class BaseInferencer(metaclass=InferencerMeta):
    ...
    def __call__(self, inputs: InputsType, return_datasamples: bool = False, batch_size: int = 1, **kwargs) -> dict:
        """Call the inferencer.
        ...
        visualization = self.visualize(ori_inputs, preds, **visualize_kwargs)  # type: ignore  # noqa: E501
    ...
    def _init_model(self, cfg: ConfigType, weights: Optional[str], device: str = "cpu") -> nn.Module:
    ...
    def _dispatch_kwargs(self, **kwargs) -> tuple[dict, dict, dict, dict]:
        ...
        return preprocess_kwargs, forward_kwargs, visualize_kwargs, postprocess_kwargs
