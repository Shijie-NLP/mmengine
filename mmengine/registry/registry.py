...
class Registry:
    ...
    def get(self, key: str) -> Optional[type]:
        ...
        if scope is None or scope == self._scope:
            ...
            try:
                ...
                print_log(
                    f"Registry node of {scope} has been automatically imported.", logger="current", level=logging.DEBUG
                )
            except (ImportError, AttributeError, ModuleNotFoundError):
                print_log(
    ...
    def register_module(
        self, name: Optional[Union[str, list[str]]] = None, force: bool = False, module: Optional[type] = None
    ) -> Union[type, Callable]:
        """Register a module.
